...
# Integrated compile and link: clang++ -> llc -> lld in one command
  ...
  target_link_libraries(nvc_get_devices PRIVATE ${CUDA_LIBRARIES} ${CUDA_CUDA_LIBRARY} UPTKdrt)
...
elseif(GPU_API STREQUAL "OPENCL")
  ...
  target_link_libraries(gpu PRIVATE OpenCL::OpenCL UPTKdrt)
  ...
  target_link_libraries(ocl_get_devices PRIVATE OpenCL::OpenCL UPTKdrt)
...
elseif(GPU_API STREQUAL "HIP")
  ...
  target_link_libraries(gpu PRIVATE hip::host UPTKdrt)
  ...
  if(HIP_USE_DEVICE_SORT)
    ...
    target_link_libraries(gpu PRIVATE hip::hipcub UPTKdrt)
  ...
  target_link_libraries(hip_get_devices PRIVATE hip::host UPTKdrt)
  ...
  if(HIP_PLATFORM STREQUAL "nvcc")
    ...
    target_link_libraries(hip_get_devices PRIVATE ${CUDA_LIBRARIES} ${CUDA_CUDA_LIBRARY} UPTKdrt)
  endif()
endif()

if(BUILD_OMP)
  find_package(OpenMP COMPONENTS CXX REQUIRED)
  target_link_libraries(gpu PRIVATE OpenMP::OpenMP_CXX UPTKdrt)
endif()
target_link_libraries(lammps PRIVATE gpu UPTKdrt)
...
if(BUILD_MPI)
  target_link_libraries(gpu PRIVATE MPI::MPI_CXX UPTKdrt)
else()
  target_link_libraries(gpu PRIVATE mpi_stubs UPTKdrt)
endif()
