...
# Integrated compile and link: clang++ -> llc -> lld in one command
    add_custom_command(OUTPUT ${CUBIN_FILE}
    VERBATIM COMMAND bash -c "
      clang++ -S -emit-llvm --cuda-device-only  -Wall
        -DUSE_CUDA -D_${GPU_PREC_SETTING} -DLAMMPS_${LAMMPS_SIZES}
        -I${LAMMPS_LIB_SOURCE_DIR}/gpu
        ${CU_FILE} -o ${LAMMPS_LIB_BINARY_DIR}/gpu/${CU_NAME}.ll &&
      llc -march=bi -filetype=obj ${LAMMPS_LIB_BINARY_DIR}/gpu/${CU_NAME}.ll -o ${LAMMPS_LIB_BINARY_DIR}/gpu/${CU_NAME}.cuda.o &&
      lld -flavor ld.lld --no-warn-missing-entry --no-undefined ${LAMMPS_LIB_BINARY_DIR}/gpu/${CU_NAME}.cuda.o -o ${CUBIN_FILE}
    "
    DEPENDS ${CU_FILE}
